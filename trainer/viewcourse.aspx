<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewcourse.aspx.cs" Inherits="trainer_viewcourse" %>
            ...
            <div class="container-fluid">
                ...
                <!-- end row -->
                 <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">View Courses</h4>
                                <p class="text-muted font-13">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [cname], [trainer], [fee] FROM [course]"></asp:SqlDataSource>
                                </p>
