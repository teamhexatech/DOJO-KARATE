<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edittournament.aspx.cs" Inherits="trainer_edittournament" %>
            ...
            <div class="container-fluid">
                ...
                <!-- end row -->
                 <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">Edit Torunament</h4>
                                <p class="text-muted font-13">
                                    <div class="text-center">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" CssClass="table-hover" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical">
                                        <AlternatingRowStyle BackColor="#CCCCCC" />
                                        <Columns>
                                            <asp:BoundField DataField="Id" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="Id">
                                            <HeaderStyle Height="60px" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="tname" HeaderText="Tournament name" SortExpression="tname">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tournament]"></asp:SqlDataSource>
                                </p>
