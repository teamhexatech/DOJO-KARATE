<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminnotifications.aspx.cs" Inherits="trainer_adminnotifications" %>
            ...
            <div class="container-fluid">
                ...
                <!-- end row -->
                 <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">Notifications From Admin</h4>
                                <p class="text-muted font-13">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [date], [title], [content] FROM [notifications]"></asp:SqlDataSource>
                                </p>
