<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editnotification.aspx.cs" Inherits="trainer_editnotification" %>
            ...
            <div class="container-fluid">
                ...
                <!-- end row -->
                 <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">Edit Notifications</h4>
                                <p class="text-muted font-13">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [stnotifications]"></asp:SqlDataSource>
                                </p>
