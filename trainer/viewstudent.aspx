<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewstudent.aspx.cs" Inherits="trainer_viewstudent" %>
            ...
            <div class="container-fluid">
                ...
                <!-- end row -->
                 <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">View Students</h4>
                                <p class="text-muted font-13">
                                    <div class="text-center">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" CssClass="table-hover" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical">
                                        <AlternatingRowStyle BackColor="#CCCCCC" />
                                        <Columns>
                                            <asp:BoundField DataField="fname" HeaderText="First Name" SortExpression="fname">
                                            <HeaderStyle Height="60px" Wrap="False" />
                                            ...
                                            <asp:BoundField DataField="mob" HeaderText="Mob No." SortExpression="mob">
                                            <HeaderStyle Wrap="False" />
                                            <ItemStyle Wrap="False" />
                                            </asp:BoundField>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [fname], [lname], [gender], [dob], [address], [email], [mob], [course], [batch] FROM [student]"></asp:SqlDataSource>
                                </p>
