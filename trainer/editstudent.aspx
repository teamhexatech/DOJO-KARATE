<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editstudent.aspx.cs" Inherits="trainer_editstudent" %>
                 ...
                 <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted font-13">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical" CssClass="table">
