<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addtournament.aspx.cs" Inherits="trainer_addtournament" %>
            ...
            <div class="container-fluid">
                ...
                <!-- end row -->
                 <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Add Tournament details</h4>
        ...
        <table style="width: 48%;">
            ...
            <tr>
                <td class="auto-style1">
                    <asp:Label ID="Label14" runat="server" Text="Tournament Name"></asp:Label>
                </td>
                <td class="auto-style1">
                    <asp:TextBox ID="tname" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tname" ErrorMessage="Enter the  tournament name" Font-Bold="True" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="time" ErrorMessage="Enter the time of  tournament" Font-Bold="True" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="date" ErrorMessage="Enter the date of tournament" Font-Bold="True" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="location" ErrorMessage="Enter Location of the tournament" Font-Bold="True" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label18" runat="server" Text="Rules"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="rules" runat="server" Height="97px" TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="rules" ErrorMessage="Include the rules of  tournament" Font-Bold="True" Font-Size="Small" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="Add Tournnament" OnClick="Button1_Click" />
                </td>
            </tr>
        </table>
    </form>
