<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewbatches.aspx.cs" Inherits="trainer_viewbatches" %>
            ...
            <div class="container-fluid">
                ...
                <!-- end row -->
                 <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">View Batches</h4>
                                <p class="text-muted font-13">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [course], [time] FROM [batch]"></asp:SqlDataSource>
                                </p>
