<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewtournament.aspx.cs" Inherits="trainer_viewtournament" %>
            ...
            <div class="container-fluid">
                ...
                <!-- end row -->
                 <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <h4 class="header-title">View Tournaments</h4>
                                <p class="text-muted font-13">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" CssClass="table-hover" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical">
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="tname" HeaderText="Trainer Name" SortExpression="tname">
