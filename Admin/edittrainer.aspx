<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edittrainer.aspx.cs" Inherits="Admin_edittrainer" %>
                        ...
                        <div class="row">
								...
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">UPDATE/DELETE TRAINER</h4>
                                        <div>   </div>
                                        <div class="text-center">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="table-responsive">
                                <Columns>
                                ...
                                <SortedDescendingHeaderStyle BackColor="#00547E" />
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [trainer]" UpdateCommand="UPDATE [trainer] set [fname]=@course, [lname]=@lname, [dob]=@dob, [gender]=@gender, [address]=@address, [email]=@email, [mob]=@mob, [designation]=@designation, [joindate]=@joindate, [rank]=@rank, [password]=@password where [id]=@id" DeleteCommand="DELETE from [trainer] where [id]=@id"></asp:SqlDataSource>
					</div>
                                    </div>
                                    </div>
                                        </form>
