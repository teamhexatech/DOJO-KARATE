<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editbatch.aspx.cs" Inherits="Admin_editbatch" %>
					...
					<div class="container-fluid">
                         ...
                         <div class="row">
						    <div class="card">
									<div class="card-header">
                                        <h4 class="card-title">Update/Delete Batches</h4>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSource1" CssClass="table-hover">
                            <Columns>
                                ...
                                <asp:BoundField DataField="time" HeaderText="TIMING" SortExpression="time" />
                                <asp:CommandField ButtonType="Image" CancelImageUrl="~/ico/cancelicon.png" EditImageUrl="~/ico/editicon.png" HeaderText="Operations" ShowEditButton="True" UpdateImageUrl="~/ico/saveicon.png" DeleteImageUrl="~/ico/deleteicon.png" ShowDeleteButton="True" >
