<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editNotifications.aspx.cs" Inherits="Notifications" %>
				...
				<div class="content">
					<div class="container-fluid">
						...
						<div class="row">
						    ...
						    <div class="card">
									<div class="card-header">
                                        <h4 class="card-title">Edit/Delete Batches</h4>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSource1" CssClass="table-hover">
                          ...
                          <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [notifications]" UpdateCommand="UPDATE [notifications] set [date]=@date, [title]=@title, [content]=@content where [id]=@id" DeleteCommand="DELETE from [notifications] where [id]=@id"></asp:SqlDataSource>
